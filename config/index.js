...
//         {"type": "节日", "name": "没有了哦搭讪纪念日", "year": "2021", "date": "12-31"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "破壳日", "name": "大哥", "year": "2003", "date": "01-01"},
//         {"type": "节日", "name": "被搭讪纪念日", "year": "2022", "date": "12-31"},
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
...
//         {"keyword": "ex_day", date: "2022-09-10"},
    ...
    },
    {
      ...
      name: "徐秋树",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "o97vH5key_GC2GYM6vFX7gWJOBh4",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "EEvALt_CWFtMNpweYrbLilcHfYpWozmLd4PxzDBYI8M",
      // 所在省份
      province: "四川",
      // 所在城市
      city: "成都",
...
//         {"keyword": "ex_day", date: "2022-09-10"},
  ...
  CALLBACK_TEMPLATE_ID: "0_wewSm4eGgwLeF8SM_GaJPAdgctCBWbruiE7daJsZw",
